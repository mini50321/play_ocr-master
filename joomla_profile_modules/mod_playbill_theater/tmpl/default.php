            ...
            <ul style="list-style: none; padding: 0; margin: 0;">
                ...
                <li style="padding: 12px 0; border-bottom: 1px solid #f3f4f6;">
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <span style="color: #6b7280; font-size: 16px; font-weight: 600; min-width: 60px;">
                            <?php echo (int)$production['year']; ?>
                        </span>
                        <?php if (!empty($production['start_date']) || !empty($production['end_date'])): ?>
                        <span style="color: #9ca3af; font-size: 14px;">
                            <?php if (!empty($production['start_date'])): ?>
                                <?php echo htmlspecialchars($production['start_date']); ?>
                            <?php endif; ?>
                            <?php if (!empty($production['start_date']) && !empty($production['end_date'])): ?>
                                - 
                            <?php endif; ?>
                            <?php if (!empty($production['end_date'])): ?>
                                <?php echo htmlspecialchars($production['end_date']); ?>
                            <?php endif; ?>
                        </span>
                        <?php endif; ?>
                    </div>
...
<style>
.playbill-theater-module ~ .item-page,
.playbill-theater-module ~ article,
.playbill-theater-module ~ .item-page,
.playbill-theater-module ~ article {
    display: none !important;
}
body.item-view .item-page:has(+ .playbill-theater-module),
body.item-view article:has(+ .playbill-theater-module) {
    display: none !important;
}
</style>
<script>
(function() {
    document.addEventListener('DOMContentLoaded', function() {
        const moduleContainer = document.querySelector('.playbill-theater-module');
        if (moduleContainer) {
