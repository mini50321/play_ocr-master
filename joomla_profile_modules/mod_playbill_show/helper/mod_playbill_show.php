...
{
    public static function getShowData($show_id, $api_base_url, $public_base_url)
    {
        if (empty($show_id)) {
            return null;
        }
        ...
        if ($http_code !== 200) {
            Log::add('Playbill show module error: HTTP ' . $http_code . ' for show ID ' . $show_id, Log::ERROR, 'mod_playbill_show');
            return null;
        }
